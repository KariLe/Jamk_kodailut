...
public class ServletLogin extends HttpServlet {
    ...
    /*Mikäli sessiota ei ole, se luodaan
        Sessiota hyödynnetään tarkistettaessa myöhemmin että
     ...
     //Käydään tulosjoukko läpi while silmukalla ja next-metodilla, joka palauttaa arvon true
     ...
     while(rs.next())
     {
       ...
       //Jos tietokannasta löytyi käyttäjän syöttämät tiedot, niin asetetaan
